...
<head>
  ...
  <title>Sistem Informasi Inventaris dan Barang Dinas Komunikasi dan Informatika || Tambah Pengguna</title>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-4 text-gray-900">Tambah User Baru :</h1>
          <div class="row">

          <!-- Tambah Kartu Inventaris B-->
          <div class="shadow-lg p-3 mb-5 col-sm-12 bg-white rounded">
          <form action="../modal/m.tambahuser.php" method="POST" data-parsley-validate class="form-horizontal form-label text-gray-900">
          <div class="my-1"></div>
                <a href="user.php" class="btn btn-info">
                    <span class="icon text-black-50"></span>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10 col-md-6">
                  <input type="text" class="form-control text-gray-900" id="colFormLabel" name="username" value="" placeholder="Username" required>
                </div>
              </div>
              <div class="form-group row">
                <label for="colFormLabel" class="control-label col-sm-2 col-form-label">Password :</label>
                <div class="col-sm-10 col-md-6">
                  <input type="password" class="form-control text-gray-900" id="colFormLabel" name="password" value="" placeholder="Password" required>
                </div>
              </div>
              <div class="form-group row">
                <label for="colFormLabel" class="control-label col-sm-2 col-form-label  text-gray-900">Level :</label>
              <div class="form-check form-check-inline">
                  <input class="form-check-input  text-gray-900" type="radio" name="level" id="inlineRadio1" value="pengurusbarang">
                  <label class="form-check-label" for="inlineRadio1">Pengurus Barang</label>
              </div>
              <div class="form-check form-check-inline text-gray-900">
                  <input class="form-check-input" type="radio" name="level" id="inlineRadio2" value="kepaladinas">
                  <label class="form-check-label" for="inlineRadio2">Kepala Dinas</label>
              </div>
              <div class="form-check form-check-inline text-gray-900">
                  <input class="form-check-input" type="radio" name="level" id="inlineRadio2" value="pegawai">
