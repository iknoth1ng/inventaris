...
<body id="page-top">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-2 text-gray-800">Kartu Inventaris Barang C</h1>

          <!-- DataTales Example -->
          <div class="card shadow mb-4">
            <div class="card-body">
                <h3 class="text-gray-900"><center>KARTU INVENTARIS BARANG (KIB) C</h3></center>
                <h3 class="text-gray-900"><center>GEDUNG DAN BANGUNAN</h3></center>
                <h3 class="text-gray-900"><center>PER DESEMBER 2017</h3></center>
            <div class="my-1"></div>
                <a href="tambah_kibC.php" class="btn btn-success">
                ...
                <a href="./pdf/document/cetak_kibC.php" class="btn btn-success">
                    <span class="icon text-black-50">
            ...
            <?php
             if(!empty($_GET['data'])){
                   echo $kib->tampil_KIBC_get($_GET['data']);   
                   $total = $kib->hargaKIBC_get($_GET['data']);                     
                 }else{
                   echo $kib->tampil_KIBC();
                   $total = $kib->hargaKIBC();
                 }
             ?>
            </tbody>   
  ...
  <script type="text/javascript">
    ...
    $('#tahun').on('change',function(){
      // alert($(this).val());
      location.href = 'kibC.php?data='+$(this).val();
    });
