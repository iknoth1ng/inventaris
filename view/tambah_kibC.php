...
<head>
  ...
  <title>Sistem Informasi Inventaris dan Barang Dinas Komunikasi dan Informatika || Tambah KIB C</title>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-4 text-gray-900">Tambah Kartu Inventaris Barang C :</h1>
          <div class="row">

          <!-- Tambah Kartu Inventaris C-->
          <div class="shadow-lg p-3 mb-5 col-sm-12 bg-white rounded">
          <form action="../modal/m.tambahKIBC.php" method="POST" data-parsley-validate class="form-horizontal form-label  text-gray-900">
            <div class="form-group row">
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-10 col-md-6">
                  <input type="text" class="form-control" id="colFormLabel text-gray-900" name="nomor_register" value="" required placeholder="Nomor Register">
                </div>
              </div>
              <div class="form-group row">
              <label for="colFormLabel" class="control-label col-sm-2 col-form-label text-gray-900">Kondisi Bangunan :</label>
                    <select class="custom-select col-sm-10 col-md-6 text-gray-900" id="inputGroupSelect01" name="kondisi_bangunan">
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-10 col-md-6">
                  <input type="number" class="form-control text-gray-900" id="colFormLabel" name="luas_lantai" value=""  placeholder="Luas Lantai (M2)">
                </div>
              </div>
              <div class="form-group row">
                <label for="colFormLabel" class="control-label col-sm-2 col-form-label">Letak/Lokasi Alamat :</label>
                <div class="col-sm-10 col-md-6">
                  <input type="text" class="form-control text-gray-900" id="colFormLabel" name="letak" value="" required placeholder="Letak/Lokasi Alamat">
                </div>
              </div>
              <div class="form-group row">
                <label for="colFormLabel" class="control-label col-sm-2 col-form-label">Tanggal Dokumen Gedung :</label>
                <div class="col-sm-10 col-md-6">
                  <input type="text" class="form-control text-gray-900" id="colFormLabel" name="tanggal" value="" placeholder="Tanggal Dokumen Gedung" required>
                </div>
              </div>
              <div class="form-group row">
                <label for="colFormLabel" class="control-label col-sm-2 col-form-label">Nomor Dokumen Gedung :</label>
                <div class="col-sm-10 col-md-6">
                  <input type="number" class="form-control text-gray-900" id="colFormLabel" name="nomor" value="" placeholder="Nomor Dokumen Gedung" required>
                </div>
              </div>
              <div class="form-group row">
                <label for="colFormLabel" class="control-label col-sm-2 col-form-label">Luas (M2):</label>
                <div class="col-sm-10 col-md-6">
                  <input type="number" class="form-control text-gray-900" id="colFormLabel" name="luas" value="" placeholder="Luas (M2)">
                </div>
              </div>
              <div class="form-group row">
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-10 col-md-6">
                  <input type="number" class="form-control text-gray-900" id="colFormLabel" name="nomor_tanah" value="" placeholder="Nomor Kode Tanah">
                </div>
              </div>
              <div class="form-group row">
