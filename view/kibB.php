...
<head>
  ...
  <title>Sistem Informasi Inventaris dan Barang Dinas Komunikasi dan Informatika || KIB B </title>
...
<body id="page-top">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-2 text-gray-800">Kartu Inventaris Barang B</h1>

          <!-- DataTales Example -->
          <div class="card shadow mb-4">
            <div class="card-body">
                <h3 class="text-gray-900"><center>KARTU INVENTARIS BARANG (KIB) B</h3></center>
                <h3 class="text-gray-900"><center>PERALATAN DAN MESIN</h3></center>
                <h3 class="text-gray-900"><center>PER DESEMBER 2017</h3></center>
            <div class="my-1"></div>
                <a href="tambah_kibB.php" class="btn btn-success">
                ...
                <a href="./pdf/document/cetak_kibB.php" class="btn btn-success">
                    <span class="icon text-black-50">
            ...
            <?php
             if(!empty($_GET['data'])){
                   echo $kib->tampil_KIBB_get($_GET['data']);   
                   $total = $kib->hargaKIBB_get($_GET['data']);                     
                 }else{
                   echo $kib->tampil_KIBB();
                   $total = $kib->hargaKIBB();
                 }
             ?>
            </tbody>   
  ...
  <script type="text/javascript">
    ...
    $('#tahun').on('change',function(){
      // alert($(this).val());
      location.href = 'kibB.php?data='+$(this).val();
    });
