...
<head>
  ...
  <title>Sistem Informasi Inventaris dan Barang Dinas Komunikasi dan Informatika || List Peminjaman Barang </title>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-2 text-gray-800">LIST PEMINJAMAN BARANG</h1>

          <!-- DataTales Example -->
          <div class="card shadow mb-4">
            <div class="card-body">
                <h3 class="text-gray-900"><center>LIST PEMINJAMAN BARANG</h3></center>
                <h3 class="text-gray-900"><center>DINAS KOMUNIKASI DAN INFORMATIKA</h3></center>
            <div class="my-1"></div>
            ...
            <tbody>
                <?php echo $peminjaman->tampil_peminjaman2(); ?>
            </tbody>    
