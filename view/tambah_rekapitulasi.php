...
<head>
  ...
  <title>Sistem Informasi Inventaris dan Barang Dinas Komunikasi dan Informatika || Tambah Kartu Inventaris Ruangan</title>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-4 text-gray-900">Tambah Kartu Inventaris Ruangan :</h1>
          <div class="row">

          <!-- Tambah Kartu Inventaris A-->
          <div class="shadow-lg p-3 mb-5 col-sm-12 bg-white rounded">
          <form action="../modal/m.tambahRekapitulasi.php" method="POST" data-parsley-validate class="form-horizontal form-label  text-gray-900">
            <div class="form-group row">
                <label for="colFormLabel" class="control-label col-sm-2 col-form-label">Nama Barang :</label>
                <div class="col-sm-10 col-md-6">
                  <input type="text" class="form-control  text-gray-900" id="mynama" name="nama_barang" value="" required placeholder="Nama Barang">
                </div>
              </div>
              <div class="form-group row">
                <label for="colFormLabel" class="control-label col-sm-2 col-form-label">Merk/Model :</label>
                <div class="col-sm-10 col-md-6">
                  <input type="text" class="form-control text-gray-900" id="colFormLabel" name="merk" value=""  placeholder="Merk/Model">
                </div>
              </div>
              <div class="form-group row">
                <label for="colFormLabel" class="control-label col-sm-2 col-form-label">No. Seri Pabrik :</label>
                <div class="col-sm-10 col-md-6">
                  <input type="text" class="form-control text-gray-900" id="colFormLabel" name="no_seri" value=""  placeholder="No. Seri Pabrik">
                </div>
              </div>
              <div class="form-group row">
                <label for="colFormLabel" class="control-label col-sm-2 col-form-label">Ukuran :</label>
                <div class="col-sm-10 col-md-6">
                  <input type="text" class="form-control text-gray-900" id="colFormLabel" name="ukuran" value="" placeholder="Ukuran">
                </div>
              </div>
              <div class="form-group row">
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-10 col-md-6">
                  <input type="text" class="form-control text-gray-900" id="colFormLabel" name="tahun_pembelian" value="" required placeholder="Tahun Pembelian">
                </div>
              </div>
              <div class="form-group row">
                <label for="colFormLabel" class="control-label col-sm-2 col-form-label">No. Kode Lokasi :</label>
                <div class="col-sm-10 col-md-6">
                  <input type="text" class="form-control text-gray-900" id="colFormLabel" name="kode_lokasi" value="" placeholder="No. Kode Lokasi">
                </div>
              </div>
              <div class="form-group row">
                <label for="colFormLabel" class="control-label col-sm-2 col-form-label">No.Kode Barang :</label>
                <div class="col-sm-10 col-md-6">
                  <input type="text" class="form-control text-gray-900" id="myautocomplite" name="kode_barang" value="" placeholder="Kode Barang" required>
                </div>
              </div>
              <div class="form-group row">
                <label for="colFormLabel" class="control-label col-sm-2 col-form-label">Jumlah Barang :</label>
                <div class="col-sm-10 col-md-6">
                  <input type="text" class="form-control text-gray-900" id="colFormLabel" name="jumlah_barang" value="" placeholder="Jumlah Barang">
                </div>
              </div>
              <div class="form-group row">
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-10 col-md-6">
                  <input type="text" class="form-control text-gray-900" id="duit" name="harga" value="" placeholder="Harga Beli/Perolehan">
                </div>
              </div>
            <div class="form-group row">
              <label for="colFormLabel" class="control-label col-sm-2 col-form-label">Keadaan Barang :</label>
                    <select class="custom-select col-sm-10 col-md-6 text-gray-900" id="inputGroupSelect01" name="keadaan">
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-10 col-md-6">
                  <input type="text" class="form-control  text-gray-900" id="colFormLabel" name="keterangan" value="" placeholder="Keterangan Mutasi">
                </div>
              </div>
              <div class="form-group row">
              <label for="colFormLabel" class="control-label col-sm-2 col-form-label">Ruangan :</label>
                    <select class="custom-select col-sm-10 col-md-6  text-gray-900" id="inputGroupSelect01" name="ruangan">
