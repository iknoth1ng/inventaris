...
<head>
  ...
  <title>Sistem Informasi Inventaris dan Barang Dinas Komunikasi dan Informatika || Ekstrakom </title>
      ...
      <?php } else if($_SESSION['level'] == 'kepaladinas'){?>
       ...
       <li class="nav-item">
        ...
        <div id="collapseFive" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header"> Kartu Inventaris Barang</h6>
            <a class="collapse-item" href="kibA1.php">KIB A</a>
            <a class="collapse-item" href="kibB1.php">KIB B</a>
            <a class="collapse-item" href="kibC1.php">KIB C</a>
            <a class="collapse-item" href="kibD1.php">KIB D</a>
            <a class="collapse-item" href="kibE1.php">KIB E</a>
            <a class="collapse-item" href="kibF1.php">KIB F</a>
          </div>
        </div>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-2 text-gray-800">Ekstrakom</h1>

          <!-- DataTales Example -->
          <div class="card shadow mb-4">
            <div class="card-body">
                <h3 class="text-gray-900"><center>KARTU INVENTARIS BARANG (KIB) B</h3></center>
                <h3 class="text-gray-900"><center>EKSTRAKOM</h3></center>
                <h3 class="text-gray-900"><center>PER DESEMBER 2016</h3></center>
            <div class="my-1"></div>
                <a href="tambah_ekstrakom.php" class="btn btn-success">
                ...
                <a href="./pdf/document/cetak_ekstrakom.php" class="btn btn-success">
                    <span class="icon text-black-50">
            ...
            <tbody>
                <?php echo $ekstrakom->tampilEkstrakom(); ?>
            </tbody>    

            <tfoot>
                <tr> 
                     <td colspan="16" align="center">Total </td>
                     <td>Rp. <?php echo $ekstrakom->hargaEkstrakom();?> </td>
                     <td></td>
                     <td colspan="2"></td>
                </tr>
            </tfoot>
