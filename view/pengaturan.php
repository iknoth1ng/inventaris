...
<head>
  ...
  <title>Sistem Informasi Inventaris dan Barang Dinas Komunikasi dan Informatika || Pengaturan</title>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-4 text-gray-900 align-content-center">Ubah Password :</h1>
          <div class="row">

          <!-- Tambah Kartu Inventaris A-->
          <div class="shadow-lg p-3 mb-5 col-sm-12 bg-white rounded">
          <form action="../modal/m.ubah_password.php" method="POST" data-parsley-validate class="form-horizontal form-label text-gray-900">
          <div class="form-group row align-items-center">
                <label for="colFormLabel" class="control-label col-sm-2 col-form-label align-items-center">Password Lama :</label>
                <div class="col-sm-9 col-md-6">
                  <input type="password" class="form-control text-gray-900 align-items-center" id="colFormLabel" name="passlama" value="" placeholder="Password Lama" required>
                </div>
              </div>
            <div class="form-group row">
                <label for="colFormLabel" class="control-label col-sm-2 col-form-label">Password Baru :</label>
                <div class="col-sm-9 col-md-6">
                  <input type="password" class="form-control  text-gray-900" id="colFormLabel" name="passbaru1" value="" placeholder="Password Baru" required>
                </div>
              </div>
              <div class="form-group row">
                <label for="colFormLabel" class="control-label col-sm-2 col-form-label">Konfirmasi Password :</label>
                <div class="col-sm-9 col-md-6">
                  <input type="password" class="form-control  text-gray-900" id="colFormLabel" name="passbaru2" value=""  placeholder="Konfirmasi Password" required>
                </div>
              </div>
