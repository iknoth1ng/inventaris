...
<head>
  ...
  <title>Sistem Informasi Inventaris dan Barang Dinas Komunikasi dan Informatika || Detail Peminjaman Barang</title>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-4 text-gray-900">Detail Peminjam Barang :</h1>
          <div class="row">
          ...
          <!-- Daftar Pengguna -->
           <div class="card shadow mb-4">
                <div class="card-header py-3" Action="">
                  <h6 class="m-0 font-weight-bold text-primary">ID Peminjam : <?php echo $peminjaman->cetak_peminjaman('id_peminjam',$_GET['id_peminjam']); ?> </h6>
                </div>
                <div class="card-body">
                    <?php
                    $mymerk = $peminjaman->cetak_peminjaman('merk_id',$_GET['id_peminjam']);
                    ?>
                    <h6 class="text-gray-900">Nama Peminjam : <?php echo $peminjaman->cetak_peminjaman('nama_peminjam',$_GET['id_peminjam']); ?></h6>
                    <h6 class="text-gray-900">Nama Barang : <?php echo $peminjaman->cetak_stok('nama_barang',$mymerk); ?> </h6>
                    <h6 class="text-gray-900">Merk Barang : <?php echo $peminjaman->cetak_stok('merk',$mymerk); ?> </h6>
                    <h6 class="text-gray-900">Ruangan : <?php echo $peminjaman->cetak_peminjaman('ruangan',$_GET['id_peminjam']); ?> </h6>
                    <h6 class="text-gray-900">Tanggal Peminjaman : <?php echo $peminjaman->cetak_peminjaman('tanggal_peminjaman',$_GET['id_peminjam']); ?> </h6>
                    <h6 class="text-gray-900">Kondisi Awal : <?php echo $peminjaman->cetak_peminjaman('kondisi_awal',$_GET['id_peminjam']); ?> </h6>
                    <h6 class="text-gray-900">Tanggal Pengembalian : <?php echo $peminjaman->cetak_peminjaman('tanggal_pengembalian',$_GET['id_peminjam']); ?> </h6>
                    <h6 class="text-gray-900">Jumlah Yang Dipinjam : <?php echo $peminjaman->cetak_peminjaman('jumlah',$_GET['id_peminjam']); ?> </h6>
                    <h6 class="text-gray-900">Keterangan : <?php echo $peminjaman->cetak_peminjaman('keterangan',$_GET['id_peminjam']); ?> </h6>
                    <h6 class="text-gray-900">Stok : <?php echo $peminjaman->cetak_stok('jumlah',$mymerk); ?> </h6> <p>
                    <!-- Example single danger button -->
                    <div>
                    <?php if($peminjaman->cetak_peminjaman('status',$_GET['id_peminjam']) != "Terima"){ ?>
                      <a class="btn btn-primary" href="../modal/m.peminjaman.php?id_pinjam=<?php echo $peminjaman->cetak_peminjaman('id_peminjam',$_GET['id_peminjam']); ?>&id_barang=<?php echo $mymerk; ?>&status=Terima" role="button">Setuju</a>
                    <?php } ?>
                    <?php if($peminjaman->cetak_peminjaman('status',$_GET['id_peminjam']) != "Tolak"){ ?>
                      <a class="btn btn-primary" href="../modal/m.peminjaman.php?id_pinjam=<?php echo $peminjaman->cetak_peminjaman('id_peminjam',$_GET['id_peminjam']); ?>&id_barang=<?php echo $mymerk; ?>&status=Tolak" role="button">Tolak</a>
                    <?php } ?>
                      <a class="btn btn-danger" href="list_peminjaman.php" role="button">Back</a>
                    </div>  
                </div>
              </div>
        <!-- /.container-fluid -->
      ...
      <footer class="sticky-footer bg-white">
        <div class="container my-auto">
          <div class="copyright text-center my-auto">
            <span>Copyright &copy; Ayu Wulandari 2019</span>
          </div>
        </div>
      </footer>
      <!-- End of Footer -->
