...
<head>
  ...
  <title>Sistem Informasi Inventaris dan Barang Dinas Komunikasi dan Informatika || KIB C </title>
...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <!-- Nav Item - List Rekapitulasi -->
      <li class="nav-item">
        <a class="nav-link" href="rekapitulasi1php?data=">
          <i class="fa fa-book"></i>
          <span>List Rekapitulasi</span></a>
      </li>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-2 text-gray-800">Kartu Inventaris Barang D</h1>

          <!-- DataTales Example -->
          <div class="card shadow mb-4">
            <div class="card-body">
                <h3 class="text-gray-900"><center>KARTU INVENTARIS BARANG (KIB) D</h3></center>
                <h3 class="text-gray-900"><center>JALAN, IRIGASI DAN JARINGAN</h3></center>
                <h3 class="text-gray-900"><center>PER DESEMBER 2017</h3></center>
            <div class="my-1"></div>
                <a href="tambah_kibD.php" class="btn btn-success">
                ...
                <a href="./pdf/document/cetak_kibD.php" class="btn btn-success">
                    <span class="icon text-black-50">
            ...
            <?php
             if(!empty($_GET['data'])){
                   echo $kib->tampil_KIBD_get($_GET['data']);   
                   $total = $kib->hargaKIBD_get($_GET['data']);                     
                 }else{
                   echo $kib->tampil_KIBD();
                   $total = $kib->hargaKIBD();
                 }
             ?>
            </tbody> 
  ...
  $('#tahun').on('change',function(){
      // alert($(this).val());
      location.href = 'kibD.php?data='+$(this).val();
    });
