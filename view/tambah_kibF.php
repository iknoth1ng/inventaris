...
<head>
  ...
  <title>Sistem Informasi Inventaris dan Barang Dinas Komunikasi dan Informatika || Tambah KIB F</title>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-4 text-gray-900">Tambah Kartu Inventaris Barang F :</h1>
          <div class="row">

          <!-- Tambah Kartu Inventaris C-->
          <div class="shadow-lg p-3 mb-5 col-sm-12 bg-white rounded">
          <form action="../modal/m.tambahKIBF.php" method="POST" data-parsley-validate class="form-horizontal form-label  text-gray-900">
            <div class="form-group row">
                <label for="colFormLabel" class="control-label col-sm-2 col-form-label">Jenis Barang/ Nama Barang :</label>
                <div class="col-sm-10 col-md-6">
                  <input type="text" class="form-control  text-gray-900" id="mynama" name="jenis_barang" value="" required placeholder="Jenis Barang/ Nama Barang">
                </div>
              </div>
              <div class="form-group row">
                <label for="colFormLabel" class="control-label col-sm-2 col-form-label">Bangunan (P, SP, D) :</label>
                <div class="col-sm-10 col-md-6">
                  <input type="text" class="form-control  text-gray-900" id="colFormLabel" name="bangunan" value="" placeholder="Bangunan (P, SP, D)g">
                </div>
              </div>
              <div class="form-group row">
              <label for="colFormLabel" class="control-label col-sm-2 col-form-label">Konstruksi Bangunan Bertingkat :</label>
                    <select class="custom-select col-sm-10 col-md-6  text-gray-900" id="inputGroupSelect01" name="bertingkat">
                        <option disable selected value="">Bertingkat/Tidak</option>
              ...
              <label for="colFormLabel" class="control-label col-sm-2 col-form-label">Konstruksi Bangunan Beton :</label>
                    <select class="custom-select col-sm-10 col-md-6  text-gray-900" id="inputGroupSelect01" name="beton">
                        <option disable selected value="">Beton/Tidak</option>
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-10 col-md-6">
                  <input type="text" class="form-control text-gray-900" id="colFormLabel" name="luas" value="" placeholder="Luas (ma)">
                </div>
              </div>
              <div class="form-group row">
                <label for="colFormLabel" class="control-label col-sm-2 col-form-label">Letak/Lokasi Alamat :</label>
                <div class="col-sm-10 col-md-6">
                  <input type="text" class="form-control text-gray-900" id="colFormLabel" name="letak" value="" placeholder="Letak/Lokasi Alamat">
                </div>
              </div>
              <div class="form-group row">
                <label for="colFormLabel" class="control-label col-sm-2 col-form-label">Tanggal Dokumen :</label>
                <div class="col-sm-10 col-md-6">
                  <input type="date" class="form-control text-gray-900" id="colFormLabel" name="tanggal" value="" placeholder="Tanggal Dokumen">
                </div>
              </div>             
              <div class="form-group row">
                <label for="colFormLabel" class="control-label col-sm-2 col-form-label">Nomor Dokumen :</label>
                <div class="col-sm-10 col-md-6">
                  <input type="text" class="form-control text-gray-900"  name="nomor" value="" placeholder="Nomor Dokumen">
                </div>
              </div>  
              <div class="form-group row">
                <label for="colFormLabel" class="control-label col-sm-2 col-form-label">Tanggal, Bulan, Tahun Mulai :</label>
                <div class="col-sm-10 col-md-6">
                  <input type="text" class="form-control text-gray-900" id="colFormLabel" name="tahun_mulai" value=""  placeholder="Tanggal, Bulan, Tahun Mulai">
                </div>
              </div>
              <div class="form-group row">
                <label for="colFormLabel" class="control-label col-sm-2 col-form-label">Status Tanah :</label>
                <div class="col-sm-10 col-md-6">
                  <input type="text" class="form-control text-gray-900" id="colFormLabel" name="status_tanah" value=""  placeholder="Status Tanah">
                </div>
              </div>
              <div class="form-group row">
                <label for="colFormLabel" class="control-label col-sm-2 col-form-label">Nomor Kode Tanah :</label>
                <div class="col-sm-10 col-md-6">
                  <input type="text" class="form-control text-gray-900" id="colFormLabel" name="nomor_kodetanah" value="" placeholder="Nomor Kode Tanah">
                </div>
              </div>
              <div class="form-group row">
                <label for="colFormLabel" class="control-label col-sm-2 col-form-label">Asal-Usul Pembiayaan :</label>
                <div class="col-sm-10 col-md-6">
                  <input type="text" class="form-control text-gray-900" id="colFormLabel" name="asal_usul" value="" placeholder="Asal-Usul Pembiayaan">
                </div>
              </div>
              <div class="form-group row">
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-10 col-md-6">
                  <input type="number" class="form-control text-gray-900" id="duit" name="nilai_kontrak" value=""  placeholder="Nilai Kontrak (Rp)">
                </div>
              </div>
              <div class="form-group row">
