<?php 
include '../config.php';
$blacklist = array("pegawai, kepaladinas");
...
<head>
  ...
  <title>Sistem Informasi Inventaris dan Barang Dinas Komunikasi dan Informatika || Aset Lain </title>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-2 text-gray-800">Aset Lain</h1>

          <!-- DataTales Example -->
          <div class="card shadow mb-4">
            <div class="card-body">
                <h3 class="text-gray-900"><center>ASET LAIN-LAIN</h3></center>
                <h3 class="text-gray-900"><center>PER DESEMBER 2016</h3></center>
            <div class="my-1"></div>
                <a href="tambah_asetlain.php" class="btn btn-success">
                ...
                <a href="./pdf/document/cetak_AsetLain.php" class="btn btn-success">
                    <span class="icon text-black-50">
            ...
            <tbody>
                <?php echo $aset->tampilasetlain(); ?>
            </tbody>    

            <tfoot>
                <tr> 
                     <td colspan="16" align="center">Total </td>
                     <td>Rp. <?php echo $aset->hargaAsetLain();?> </td>
                     <td></td>
                     <td colspan="2"></td>
                </tr>
            </tfoot>
