...
<head>
  ...
  <title>Sistem Informasi Inventaris dan Barang Dinas Komunikasi dan Informatika || Tambah KIB D</title>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-4 text-gray-900">Tambah Kartu Inventaris Barang D :</h1>
          <div class="row">

          <!-- Tambah Kartu Inventaris C-->
          <div class="shadow-lg p-3 mb-5 col-sm-12 bg-white rounded">
          <form action="../modal/m.tambahKIBD.php" method="POST" data-parsley-validate class="form-horizontal form-label  text-gray-900">
            <div class="form-group row">
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-10 col-md-6">
                  <input type="text" class="form-control text-gray-900" id="colFormLabel" name="konstruksi" value="" placeholder="Konstruksi">
                </div>
              </div>
              <div class="form-group row">
                <label for="colFormLabel" class="control-label col-sm-2 col-form-label">Panjang (Km) :</label>
                <div class="col-sm-10 col-md-6">
                  <input type="number" class="form-control text-gray-900" id="colFormLabel" name="panjang" value="" placeholder="Panjang (Km)">
                </div>
              </div>             
              <div class="form-group row">
                <label for="colFormLabel" class="control-label col-sm-2 col-form-label">Lebar (m) :</label>
                <div class="col-sm-10 col-md-6">
                  <input type="number" class="form-control text-gray-900" id="colFormLabel" name="lebar" value="" placeholder="Lebar (m)">
                </div>
              </div>  
              <div class="form-group row">
                <label for="colFormLabel" class="control-label col-sm-2 col-form-label">Luas :</label>
                <div class="col-sm-10 col-md-6">
                  <input type="number" class="form-control text-gray-900" id="colFormLabel" name="luas" value=""  placeholder="Luas">
                </div>
              </div>
              <div class="form-group row">
                <label for="colFormLabel" class="control-label col-sm-2 col-form-label">Letak/Lokasi :</label>
                <div class="col-sm-10 col-md-6">
                  <input type="text" class="form-control text-gray-900" id="colFormLabel" name="letak" value="" required placeholder="Letak/Lokasi">
                </div>
              </div>
              <div class="form-group row">
                <label for="colFormLabel" class="control-label col-sm-2 col-form-label">Tanggal Dokumen :</label>
                <div class="col-sm-10 col-md-6">
                  <input type="text" class="form-control text-gray-900" id="colFormLabel" name="tanggal" value="" placeholder="Tanggal Dokumen" required>
                </div>
              </div>
              <div class="form-group row">
                <label for="colFormLabel" class="control-label col-sm-2 col-form-label">Nomor Dokumen :</label>
                <div class="col-sm-10 col-md-6">
                  <input type="number" class="form-control text-gray-900" id="colFormLabel" name="nomor" value="" placeholder="Nomor Dokumen" required>
                </div>
              </div>
              <div class="form-group row">
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-10 col-md-6">
                  <input type="number" class="form-control text-gray-900" id="colFormLabel" name="nomor_kodetanah" value="" placeholder="Nomor Kode Tanah">
                </div>
              </div>
              <div class="form-group row">
                <label for="colFormLabel" class="control-label col-sm-2 col-form-label">Asal Usul :</label>
                <div class="col-sm-10 col-md-6">
                  <input type="text" class="form-control text-gray-900" id="colFormLabel" name="asal_usul" required value="" placeholder="Asal Usul">
                </div>
              </div>
              <div class="form-group row">
