...
<head>
  ...
  <title>Sistem Informasi Inventaris dan Barang Dinas Komunikasi dan Informatika || Tambah Master Data</title>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-4 text-gray-900">Tambah Master Data :</h1>
          <div class="row">

          <!-- Tambah Kartu Inventaris A-->
          <div class="shadow-lg p-3 mb-5 col-sm-12 bg-white rounded">
          <form action="../modal/m.tambahmaster.php" method="POST" data-parsley-validate class="form-horizontal form-label  text-gray-900">
            <div class="form-group row">
                <label for="colFormLabel" class="control-label col-sm-2 col-form-label">Golongan :</label>
                <div class="col-sm-10 col-md-6">
                  <input type="text" class="form-control text-gray-900" id="colFormLabel" name="golongan" value="" required placeholder="Golongan">
                </div>
              </div>
              <div class="form-group row">
                <label for="colFormLabel" class="control-label col-sm-2 col-form-label">Bidang :</label>
                <div class="col-sm-10 col-md-6">
                  <input type="text" class="form-control text-gray-900" id="colFormLabel" name="bidang" value=""  placeholder="Bidang">
                </div>
              </div>
              <div class="form-group row">
                <label for="colFormLabel" class="control-label col-sm-2 col-form-label">Kelompok :</label>
                <div class="col-sm-10 col-md-6">
                  <input type="text" class="form-control text-gray-900" id="colFormLabel" name="kelompok" value=""  placeholder="Kelompok">
                </div>
              </div>
              <div class="form-group row">
                <label for="colFormLabel" class="control-label col-sm-2 col-form-label">Sub Kelompok :</label>
                <div class="col-sm-10 col-md-6">
                  <input type="text" class="form-control text-gray-900" id="colFormLabel" name="sub_kelompok" value="" placeholder="Sub Kelompok">
                </div>
              </div>
              <div class="form-group row">
                <label for="colFormLabel" class="control-label col-sm-2 col-form-label">Sub-sub Kelompok :</label>
                <div class="col-sm-10 col-md-6">
                  <input type="text" class="form-control" id="colFormLabel" name="sub_sub_kelompok" value="" required placeholder="Sub-sub Kelompok">
                </div>
              </div>
              <div class="form-group row">
                <label for="colFormLabel" class="control-label col-sm-2 col-form-label">Kode Barang :</label>
                <div class="col-sm-10 col-md-6">
                  <input type="text" class="form-control text-gray-900" id="colFormLabel" name="kode_barang" value="" required placeholder="Kode Barang">
                </div>
              </div>
              <div class="form-group row">
                <label for="colFormLabel" class="control-label col-sm-2 col-form-label">Uraian :</label>
                <div class="col-sm-10 col-md-6">
                  <input type="text" class="form-control text-gray-900" id="colFormLabel" name="uraian" value="" required placeholder="Uraian">
                </div>
              </div>
              <div class="form-group row">
                <label for="colFormLabel" class="control-label col-sm-2 col-form-label">Masa Manfaat :</label>
                <div class="col-sm-10 col-md-6">
                  <input type="text" class="form-control text-gray-900" id="colFormLabel" name="masa_manfaat" value="" placeholder="Masa Manfaat">
                </div>
              </div>
              <div class="form-group row">
                <label for="colFormLabel" class="control-label col-sm-2 col-form-label">Nilai Penyusutan :</label>
                <div class="col-sm-10 col-md-6">
                  <input type="text" class="form-control text-gray-900" id="colFormLabel" name="nilai_penyusutan" value="" placeholder="Nilai Penyusutan">
                </div>
              </div>
              <div class="form-group row">
                <label for="colFormLabel" class="control-label col-sm-2 col-form-label">/tahun :</label>
                <div class="col-sm-10 col-md-6">
                  <input type="text" class="form-control text-gray-900" id="colFormLabel" name="tahun" value="" placeholder="/tahun">
                </div>
              </div>
