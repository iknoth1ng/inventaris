...
<head>
  ...
  <title>Sistem Informasi Inventaris dan Barang Dinas Komunikasi dan Informatika || Edit KIB A</title>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-4 text-gray-900">Edit Kartu Inventaris Barang A :</h1>
          <div class="row">

          <!-- Edit Kartu Inventaris A-->
          <div class="shadow-lg p-3 mb-5 col-sm-12 bg-white rounded">
          <form action="../modal/m.ubahKIBA.php" method="POST" data-parsley-validate class="form-horizontal form-label text-gray-900">
          <div class="form-group row">
                <label for="colFormLabel" class="control-label col-sm-2 col-form-label">ID KIB A :</label>
                <div class="col-sm-10 col-md-6">
                  <input type="text" readonly class="form-control text-gray-900"  name="id_kibA" value="<?php echo $_GET['id_kibA']; ?>" placeholder="ID" >
                </div>
              </div>
            <div class="form-group row">
                <label for="colFormLabel" class="control-label col-sm-2 col-form-label">Jenis Barang / Nama Barang :</label>
                <div class="col-sm-10 col-md-6">
                  <input type="text" class="form-control text-gray-900" name="jenis_barang" value="<?php echo $kib->cetak_kibA('jenis_barang',$_GET['id_kibA']); ?>" required placeholder="Jenis Barang / Nama Barang">
                </div>
              </div>
              <div class="form-group row">
                <label for="colFormLabel" class="control-label col-sm-2 col-form-label">Kode Barang :</label>
                <div class="col-sm-10 col-md-6">
                  <input type="text" class="form-control text-gray-900" name="kode_barang" value="<?php echo $kib->cetak_kibA('kode_barang',$_GET['id_kibA']); ?>" required placeholder="Jenis Barang / Nama Barang">
                </div>
              </div>
              <div class="form-group row">
                <label for="colFormLabel" class="control-label col-sm-2 col-form-label">Nomor Register :</label>
                <div class="col-sm-10 col-md-6">
                  <input type="text" class="form-control text-gray-900" name="nomor_register" value="<?php echo $kib->cetak_kibA('nomor_register',$_GET['id_kibA']); ?>" required placeholder="Nomor Register">
                </div>
              </div>
              <div class="form-group row">
                <label for="colFormLabel" class="control-label col-sm-2 col-form-label">Luas (M2) :</label>
                <div class="col-sm-10 col-md-6">
                  <input type="number" class="form-control" name="luas" required value="<?php echo $kib->cetak_kibA('luas',$_GET['id_kibA']); ?>" placeholder="Luas (M2)">
                </div>
              </div>
              <div class="form-group row">
                <label for="colFormLabel" class="control-label col-sm-2 col-form-label">Tahun Pengadaan :</label>
                <div class="col-sm-10 col-md-6">
                  <input type="text" class="form-control text-gray-900" name="tahun_pengadaan" value="<?php echo $kib->cetak_kibA('tahun_pengadaan',$_GET['id_kibA']); ?>" required placeholder="Tahun Pengadaan">
                </div>
              </div>
              <div class="form-group row">
                <label for="colFormLabel" class="control-label col-sm-2 col-form-label">Letak/ Alamat :</label>
                <div class="col-sm-10 col-md-6">
                  <input type="text" class="form-control text-gray-900" name="letak" value="<?php echo $kib->cetak_kibA('letak',$_GET['id_kibA']); ?>" required placeholder="Letak/ Alamat">
                </div>
              </div>
              <div class="form-group row">
                <label for="colFormLabel" class="control-label col-sm-2 col-form-label">Hak Status Tanah :</label>
                <div class="col-sm-10 col-md-6">
                  <input type="text" class="form-control text-gray-900" name="hak" value="<?php echo $kib->cetak_kibA('hak',$_GET['id_kibA']); ?>" required placeholder="Hak Status Tanah">
                </div>
              </div>
              <div class="form-group row">
                <label for="colFormLabel" class="control-label col-sm-2 col-form-label">Tanggal Sertifikat :</label>
                <div class="col-sm-10 col-md-6">
                  <input type="date" class="form-control text-gray-900" name="tanggal" value="<?php echo $kib->cetak_kibA('tanggal',$_GET['id_kibA']); ?>" placeholder="Tanggal Sertifikat">
                </div>
              </div>
              <div class="form-group row">
                <label for="colFormLabel" class="control-label col-sm-2 col-form-label">Nomor Sertifikat :</label>
                <div class="col-sm-10 col-md-6">
                  <input type="number" class="form-control text-gray-900" name="nomor" value="<?php echo $kib->cetak_kibA('nomor',$_GET['id_kibA']); ?>" placeholder="Nomor Sertifikat">
                </div>
              </div>
              <div class="form-group row">
                <label for="colFormLabel" class="control-label col-sm-2 col-form-label">Penggunaan :</label>
                <div class="col-sm-10 col-md-6">
                  <input type="text" class="form-control text-gray-900" id="colFormLabel" name="penggunaan" value="<?php echo $kib->cetak_kibA('penggunaan',$_GET['id_kibA']); ?>" placeholder="Penggunaan">
                </div>
              </div>
              <div class="form-group row">
                <label for="colFormLabel" class="control-label col-sm-2 col-form-label">Asal Usul :</label>
                <div class="col-sm-10 col-md-6">
                  <input type="text" class="form-control text-gray-900" name="asal_usul" value="<?php echo $kib->cetak_kibA('asal_usul',$_GET['id_kibA']); ?>" placeholder="Asal Usul">
                </div>
              </div>
              <div class="form-group row">
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-10 col-md-6">
                  <input type="number" class="form-control text-gray-900" name="harga" value="<?php echo $kib->cetak_kibA('harga',$_GET['id_kibA']); ?>" id="duit" required placeholder="Harga (Rp)">
                </div>
              </div>
              <div class="form-group row">
                <label for="colFormLabel" class="control-label col-sm-2 col-form-label">Keterangan :</label>
                <div class="col-sm-10 col-md-6">
                  <input type="text" class="form-control text-gray-900" id="colFormLabel" name="keterangan" value="<?php echo $kib->cetak_kibA('keterangan',$_GET['id_kibA']); ?>"  placeholder="Keterangan">
                </div>
              </div>
