...
<head>
  ...
  <title>Sistem Informasi Inventaris dan Barang Dinas Komunikasi dan Informatika || Edit Kartu Inventaris Ruangan</title>
...
<body id="page-top">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-4 text-gray-900">Edit Kartu Inventaris Ruangan :</h1>
          <div class="row">

          <!-- Tambah Kartu Inventaris A-->
          <div class="shadow-lg p-3 mb-5 col-sm-12 bg-white rounded">
          <form action="../modal/m.ubahRekapitulasi.php" method="POST" data-parsley-validate class="form-horizontal form-label  text-gray-900">
          <div class="form-group row">
                <label for="colFormLabel" class="control-label col-sm-2 col-form-label">ID Rekapitulasi:</label>
                <div class="col-sm-10 col-md-6">
                  <input type="text" readonly class="form-control text-gray-900" id="colFormLabel" placeholder="ID" name="id_rekapitulasi" value="<?php echo $_GET['id_rekapitulasi']; ?>">
                </div>
              </div>
            <div class="form-group row">
                <label for="colFormLabel" class="control-label col-sm-2 col-form-label">Nama Barang :</label>
                <div class="col-sm-10 col-md-6">
                  <input type="text" class="form-control  text-gray-900" id="colFormLabel" name="nama_barang" value="<?php echo $rekapitulasi->cetak_rekapitulasi('nama_barang',$_GET['id_rekapitulasi']); ?>" placeholder="Nama Barang" required>
                </div>
              </div>
              <div class="form-group row">
                <label for="colFormLabel" class="control-label col-sm-2 col-form-label">Merk/Model :</label>
                <div class="col-sm-10 col-md-6">
                  <input type="text" class="form-control text-gray-900" id="colFormLabel" name="merk" value="<?php echo $rekapitulasi->cetak_rekapitulasi('merk',$_GET['id_rekapitulasi']); ?>" placeholder="Merk/Model">
                </div>
              </div>
              <div class="form-group row">
                <label for="colFormLabel" class="control-label col-sm-2 col-form-label">No. Seri Pabrik :</label>
                <div class="col-sm-10 col-md-6">
                  <input type="text" class="form-control text-gray-900" id="colFormLabel" name="no_seri" value="<?php echo $rekapitulasi->cetak_rekapitulasi('no_seri',$_GET['id_rekapitulasi']); ?>"  placeholder="No. Seri Pabrik">
                </div>
              </div>
              <div class="form-group row">
                <label for="colFormLabel" class="control-label col-sm-2 col-form-label">Ukuran :</label>
                <div class="col-sm-10 col-md-6">
                  <input type="text" class="form-control text-gray-900" id="colFormLabel" name="ukuran" value="<?php echo $rekapitulasi->cetak_rekapitulasi('ukuran',$_GET['id_rekapitulasi']); ?>" placeholder="Ukuran">
                </div>
              </div>
              <div class="form-group row">
                <label for="colFormLabel" class="control-label col-sm-2 col-form-label">Bahan :</label>
                <div class="col-sm-10 col-md-6">
                  <input type="text" class="form-control text-gray-900" id="colFormLabel" name="bahan" value="<?php echo $rekapitulasi->cetak_rekapitulasi('bahan',$_GET['id_rekapitulasi']); ?>" placeholder="Bahan" required>
                </div>
              </div>
              <div class="form-group row">
                <label for="colFormLabel" class="control-label col-sm-2 col-form-label">Tahun Pembelian :</label>
                <div class="col-sm-10 col-md-6">
                  <input type="text" class="form-control text-gray-900" id="colFormLabel" name="tahun_pembelian" value="<?php echo $rekapitulasi->cetak_rekapitulasi('tahun_pembelian',$_GET['id_rekapitulasi']); ?>" required placeholder="Tahun Pembelian">
                </div>
              </div>
              <div class="form-group row">
                <label for="colFormLabel" class="control-label col-sm-2 col-form-label">No. Kode Lokasi :</label>
                <div class="col-sm-10 col-md-6">
                  <input type="text" class="form-control text-gray-900" id="colFormLabel" name="kode_lokasi" value="<?php echo $rekapitulasi->cetak_rekapitulasi('kode_lokasi',$_GET['id_rekapitulasi']); ?>" placeholder="No. Kode Lokasi">
                </div>
              </div>
              <div class="form-group row">
                <label for="colFormLabel" class="control-label col-sm-2 col-form-label">No.Kode Barang :</label>
                <div class="col-sm-10 col-md-6">
                  <input type="text" class="form-control text-gray-900" id="colFormLabel" name="kode_barang" value="<?php echo $rekapitulasi->cetak_rekapitulasi('kode_barang',$_GET['id_rekapitulasi']); ?>" placeholder="Kode Barang" required>
                </div>
              </div>
              <div class="form-group row">
                <label for="colFormLabel" class="control-label col-sm-2 col-form-label">Jumlah Barang :</label>
                <div class="col-sm-10 col-md-6">
                  <input type="text" class="form-control text-gray-900" id="colFormLabel" name="jumlah_barang" value="<?php echo $rekapitulasi->cetak_rekapitulasi('jumlah_barang',$_GET['id_rekapitulasi']); ?>" placeholder="Jumlah Barang">
                </div>
              </div>
              <div class="form-group row">
              ...
              <div class="form-group row">
                <label for="colFormLabel" class="control-label col-sm-2 col-form-label">Harga Beli/Perolehan :</label>
                <div class="col-sm-10 col-md-6">
                  <input type="text" class="form-control text-gray-900" id="duit" name="harga" value="<?php echo $rekapitulasi->cetak_rekapitulasi('harga',$_GET['id_rekapitulasi']); ?>" placeholder="Harga Beli/Perolehan">
                </div>
              </div>
            <div class="form-group row">
              <label for="colFormLabel" class="control-label col-sm-2 col-form-label">Keadaan Barang :</label>
                    <select class="custom-select col-sm-10 col-md-6 text-gray-900" name="keadaan" value="" id="keadaan_barang">
                        <option disable value="">B/KB/RB</option>
              ...
              <div class="form-group row">
                <label for="colFormLabel" class="control-label col-sm-2 col-form-label">Keterangan Mutasi DLL :</label>
                <div class="col-sm-10 col-md-6">
                  <input type="text" class="form-control  text-gray-900" id="colFormLabel" name="keterangan" value="<?php echo $rekapitulasi->cetak_rekapitulasi('keterangan',$_GET['id_rekapitulasi']); ?>" placeholder="Keterangan Mutasi">
                </div>
              </div>
              <div class="form-group row">
              <label for="colFormLabel" class="control-label col-sm-2 col-form-label">Ruangan :</label>
                    <select class="custom-select col-sm-10 col-md-6  text-gray-900" id="ruangan" name="ruangan" value="">
  ...
  <script type="text/javascript">
    $("#keadaan_barang option[value='<?php echo $rekapitulasi->cetak_rekapitulasi('keadaan',$_GET['id_rekapitulasi']); ?>']").prop('selected',true);
    $("#ruangan option[value='<?php echo $rekapitulasi->cetak_rekapitulasi('ruangan',$_GET['id_rekapitulasi']); ?>']").prop('selected',true);
