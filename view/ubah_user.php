...
<head>
  ...
  <title>Sistem Informasi Inventaris dan Barang Dinas Komunikasi dan Informatika || Edit Profile User</title>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-4 text-gray-900">Edit Profile Pengguna :</h1>
          <div class="row">

          <!-- Tambah Kartu Inventaris A-->
          <div class="shadow-lg p-3 mb-5 col-sm-12 bg-white rounded">
          <form action="../modal/m.ubah_user.php" method="POST" data-parsley-validate class="form-horizontal form-label text-gray-900" enctype="multipart/form-data">
            <div class="form-group row">
                <label for="colFormLabel" class="control-label col-sm-2 col-form-label">Nama Lengkap :</label>
                <div class="col-sm-10 col-md-6">
                  <input type="text" class="form-control text-gray-900" id="colFormLabel" name="fullname" value="<?php echo $user->tampil_user("fullname", $_SESSION['iduser']) ;?>" placeholder="Nama Lengkap">
                </div>
              </div>
              <div class="form-group row">
                <label for="colFormLabel" class="control-label col-sm-2 col-form-label">Username :</label>
                <div class="col-sm-10 col-md-6">
                  <input type="text" class="form-control text-gray-900" id="colFormLabel" name="username" value="<?php echo $user->tampil_user("username", $_SESSION['iduser']) ;?>"  placeholder="Username">
                </div>
              </div>
              <div class="form-group row">
                <label for="colFormLabel" class="control-label col-sm-2 col-form-label">NIP :</label>
                <div class="col-sm-10 col-md-6">
                  <input type="text" class="form-control text-gray-900" id="colFormLabel" name="nip" value="<?php echo $user->tampil_user("nip", $_SESSION['iduser']) ;?>"  placeholder="NIP">
                </div>
              </div>
              <div class="form-group row">
                <label for="colFormLabel" class="control-label col-sm-2 col-form-label">Jabatan :</label>
                <div class="col-sm-10 col-md-6">
                  <input type="text" class="form-control text-gray-900" id="colFormLabel" name="jabatan" value="<?php echo $user->tampil_user("jabatan", $_SESSION['iduser']) ;?>" placeholder="Jabatan">
                </div>
              </div>
              <div class="form-group row">
                <label for="colFormLabel" class="control-label col-sm-2 col-form-label">Foto :</label>
                <div class="col-sm-10 col-md-6">
                  <input type="file" class="form-control text-gray-900" id="colFormLabel" name="foto" value="" placeholder="">
                </div>
              </div>
