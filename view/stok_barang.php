...
<head>
  ...
  <title>Sistem Informasi Inventaris dan Barang Dinas Komunikasi dan Informatika || Stok Barang </title>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <!-- Content Row -->
          <h1 class="h3 mb-4 text-gray-900">Tambah Stok Barang :</h1>
          <div class="row">

        <!-- Tambah Stok Barang -->
        <div class="shadow-lg p-3 mb-5 col-sm-12 bg-white rounded">
          <form action="../modal/m.tambahStok.php" method="POST" data-parsley-validate class="form-horizontal form-label">
          <div class="form-group row">
                <label for="colFormLabel" class="control-label col-sm-2 col-form-label text-gray-900">ID Stok :</label>
                <div class="col-sm-10 col-md-6">
                  <input type="text" class="form-control" id="colFormLabel" name="id_stok" value="<?php echo $peminjaman->generateRandomString() ;?>" placeholder="" readonly>
                </div>
            </div>
            <div class="form-group row">
                <label for="colFormLabel" class="control-label col-sm-2 col-form-label text-gray-900">Nama Barang :</label>
                <div class="col-sm-10 col-md-6">
                  <input type="text" class="form-control text-gray-900" id="colFormLabel" name="nama_barang" value=""  placeholder="Nama Barang">
                </div>
            </div>
            <div class="form-group row">
                <label for="colFormLabel" class="control-label col-sm-2 col-form-label text-gray-900">Merk :</label>
                <div class="col-sm-10 col-md-6">
                  <input type="text" class="form-control text-gray-900" id="colFormLabel" name="merk" value="" placeholder="Merk">
                </div>
            </div>
            <div class="form-group row">
                <label for="colFormLabel" class="control-label col-sm-2 col-form-label text-gray-900">Jumlah Barang :</label>
                <div class="col-sm-10 col-md-6">
                  <input type="text" class="form-control text-gray-900" id="colFormLabel" name="jumlah" value="" placeholder="Jumlah Barang">
                </div>
            </div>
            <div class="form-group row">
            ...
            <div class="card-body">
              <div class="table-responsive text-gray-900">
                <table class="table table-bordered text-gray-900" id="dataTable" width="100%" cellspacing="0">
                  ...
                  <tbody>
                    <?php echo $peminjaman->tampil_stok(); ?>
                  </tbody> 
