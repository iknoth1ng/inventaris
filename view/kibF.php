...
<head>
  ...
  <title>Sistem Informasi Inventaris dan Barang Dinas Komunikasi dan Informatika || KIB F </title>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-2 text-gray-800">Kartu Inventaris Barang F</h1>

          <!-- DataTales Example -->
          <div class="card shadow mb-4">
            <div class="card-body">
                <h3 class="text-gray-900"><center>KARTU INVENTARIS BARANG (KIB) F</h3></center>
                <h3 class="text-gray-900"><center>KONSTRUKSI DALAM PENGERJAAN</h3></center>
                <h3 class="text-gray-900"><center>PER DESEMBER 2016</h3></center>
            <div class="my-1"></div>
                <a href="tambah_kibF.php" class="btn btn-success">
                ...
                <a href="./pdf/document/cetak_kibF.php" class="btn btn-success">
                    <span class="icon text-black-50">
              ...
              <div class="table-responsive text-gray-900">
                ...
                <thead>
                    <tr>
                          ...
                          <th rowspan="2">Asal Usul Pembiayaan</th>
            ...
            <tbody>
                <?php echo $kib->tampil_KIBF(); ?>
            </tbody> 

            <tfoot>
                <tr> 
                    <td colspan="13" align="center">Total </td>
                    <td>Rp. <?php echo  $kib->hargaKIBF();?> </td>
                    <td></td>
                    <td colspan="2"></td>
                </tr>
            </tfoot>      
