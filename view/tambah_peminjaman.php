    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <form action="../modal/m.tambahPeminjaman.php" method="POST" data-parsley-validate class="form-horizontal form-label text-gray-900">
          <div class="form-group row">
            ...
            <div class="form-group row">
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-10 col-md-6">
                  <input type="date" class="form-control text-gray-900" id="colFormLabel" name="tanggal_peminjaman" value="" required placeholder="Tanggal Peminjaman">
                </div>
              </div>
              <div class="form-group row">
