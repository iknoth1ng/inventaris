...
<head>
  ...
  <title>Sistem Informasi Inventaris dan Barang Dinas Komunikasi dan Informatika || Master Data </title>
      ...
      <div id="content">
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown no-arrow">
              <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                <span class="mr-2 d-none d-lg-inline text-gray-800 medium"><?php echo $user->tampil_user("fullname", $_SESSION['iduser']) ;?></>
        ...
        <div class="container-fluid">
          ...
          <div class="card shadow mb-4">
            <div class="card-body">
                <h3 class="text-gray-900"><center>REKAPITULASI ASET TETAP & PENYUSUTAN ASET TETAP</h3></center>
                <h3 class="text-gray-900"><center>INSPEKTORAT DAERAH KOTA KOTA BATAM</h3></center>
                <h3 class="text-gray-900"><center>PERIODE : AKHIR TAHUN ANGGARAN 2016</h3></center>
            <div class="my-1"></div>
                <a href="tambah_master.php" class="btn btn-success">
              ...
              <div class="table-responsive text-gray-900">
                ...
                <thead>
                        <tr>
                          ...
                          <th rowspan="2">Sub-sub Kelompok</th>
                          <th rowspan="2">Kode Barang</th>
                          <th rowspan="2">Uraian</th>
                          <th colspan="3">Masa Manfaat/Nilai Penyusutan Pertahun</th>
                          <th rowspan="2" colspan="2">Action</th>                 
                        </tr>
                     
                        <tr>
                          <th>Masa Manfaat</th>
                          <th colspan="2">Nilai Penyusutan/tahun</th>
                        </tr>  
            ...
            <tbody>
                <?php echo $master_data->tampilMaster(); ?>
            </tbody>  
