...
<head>
  ...
  <title>Sistem Informasi Inventaris dan Barang Dinas Komunikasi dan Informatika || Edit Peminjaman</title>
...
<body id="page-top">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-4 text-gray-900">Edit Peminjaman :</h1>
          <div class="row">

          <!-- Tambah Kartu Inventaris A-->
          <div class="shadow-lg p-3 mb-5 col-sm-12 bg-white rounded">
          <form action="../modal/m.ubahPeminjaman.php" method="POST" data-parsley-validate class="form-horizontal form-label text-gray-900">
          <div class="form-group row">
                <label for="colFormLabel" class="control-label col-sm-2 col-form-label">ID Pemijam :</label>
                <div class="col-sm-10 col-md-6">
                  <input type="text" readonly class="form-control text-gray-900" id="colFormLabel" placeholder="ID" name="id_peminjam" value="<?php echo $_GET['id_peminjam']; ?>">
                </div>
              </div>
            <div class="form-group row">
                <label for="colFormLabel" class="control-label col-sm-2 col-form-label">Nama Peminjam:</label>
                <div class="col-sm-10 col-md-6">
                  <input type="text" class="form-control text-gray-900" id="colFormLabel" name="nama_peminjam" value="<?php echo $peminjaman->cetak_peminjaman('nama_peminjam',$_GET['id_peminjam']); ?>" placeholder="Nama Peminjam">
                </div>
              </div>
              <div class="form-group row">
              ...
              <label for="colFormLabel" class="control-label col-sm-2 col-form-label">Ruangan :</label>
                    <select class="custom-select col-sm-10 col-md-6 text-gray-900" id="ruangan" name="ruangan" value="" required>
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-10 col-md-6">
                  <input type="date" class="form-control text-gray-900" id="colFormLabel" name="tanggal_peminjaman" value="<?php echo $peminjaman->cetak_peminjaman('tanggal_peminjaman',$_GET['id_peminjam']); ?>" placeholder="Tanggal Peminjaman" required>
                </div>
              </div>
              <div class="form-group row">
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-10 col-md-6">
                  <input type="date" class="form-control text-gray-900" id="colFormLabel" name="tanggal_pengembalian" value="<?php echo $peminjaman->cetak_peminjaman('tanggal_pengembalian',$_GET['id_peminjam']); ?>" placeholder="Tanggal Pengembalian" required>
                </div>
              </div>
              <div class="form-group row">
                <label for="colFormLabel" class="control-label col-sm-2 col-form-label">Jumlah Yang Dipinjam :</label>
                <div class="col-sm-10 col-md-6">
                  <input type="number" class="form-control  text-gray-900" id="colFormLabel" name="jumlah" value="<?php echo $peminjaman->cetak_peminjaman('jumlah',$_GET['id_peminjam']); ?>" placeholder="Jumlah Yang Dipinjam" required>
                </div>
              </div>
              <div class="form-group row">
                <label for="colFormLabel" class="control-label col-sm-2 col-form-label">Keterangan :</label>
                <div class="col-sm-10 col-md-6">
                  <input type="text" class="form-control text-gray-900" id="colFormLabel" name="keterangan" value="<?php echo $peminjaman->cetak_peminjaman('keterangan',$_GET['id_peminjam']); ?>" placeholder="Keterangan">
                </div>
              </div>
  ...
  <script type="text/javascript">
    $("#nama_barang option[value='<?php echo $peminjaman->cetak_peminjaman('merk_id',$_GET['id_peminjam']); ?>']").prop('selected',true);
    $("#ruangan option[value='<?php echo $peminjaman->cetak_peminjaman('ruangan',$_GET['id_peminjam']); ?>']").prop('selected',true);
    $("#kondisi_awal option[value='<?php echo $peminjaman->cetak_peminjaman('kondisi_awal',$_GET['id_peminjam']); ?>']").prop('selected',true);
    </script>
