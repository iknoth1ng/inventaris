...
<head>
  ...
  <title>Sistem Informasi Inventaris dan Barang Dinas Komunikasi dan Informatika || Daftar Pengguna</title>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-4 text-gray-900">Profile : </h1>
          <div class="row">
          ...
          <!-- Daftar Pengguna -->
           <div class="card shadow mb-4">
                <div class="card-header py-3">
                  <a href="ubah_user.php" class="btn btn-primary btn-circle">
                  <i class="fas fa-edit"></i>
                  </a>
                </div>
                <div class="card-body">
                    <img src="./img/gambar/<?php echo $user->tampil_user("foto", $_SESSION['iduser']) ;?>" class="rounded mx-auto d-block" alt="IMG" width="300" height="200">
                    <h6 class="text-gray-900">ID User : <?php echo $user->tampil_user("id_user", $_SESSION['iduser']) ;?>  </h6>
                    <h6 class="text-gray-900">Nama : <?php echo $user->tampil_user("fullname", $_SESSION['iduser']) ;?> </h6>
                    <h6 class="text-gray-900">Nip : <?php echo $user->tampil_user("nip", $_SESSION['iduser']) ;?> </h6>
                    <h6 class="text-gray-900">Jabatan : <?php echo $user->tampil_user("jabatan", $_SESSION['iduser']) ;?> </h6>
                    <h6 class="text-gray-900">Username : <?php echo $user->tampil_user("username", $_SESSION['iduser']) ;?> </h6>
                </div>
              </div>
        <!-- /.container-fluid -->
    </div>
