...
<head>
  ...
  <title>Sistem Informasi Inventaris dan Barang Dinas Komunikasi dan Informatika || Barang Pakai Habis </title>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-2 text-gray-800">Barang Pakai Habis</h1>

          <!-- DataTales Example -->
          <div class="card shadow mb-4">
            <div class="card-body">
                <h3 class="text-gray-900"><center></h3></center>
                <h3 class="text-gray-900"><center>Barang Pakai Habis</h3></center>
            <div class="my-1"></div>
                <a href="tambah_barang_pakai.php" class="btn btn-success">
                ...
                <a href="./pdf/document/cetak_barang.php" class="btn btn-success">
                    <span class="icon text-black-50">
            ...
            <tbody>
                <?php echo $barang_pakai->tampilBarangPakai(); ?>
            </tbody>    

            <tfoot>
                <tr> 
                     <td colspan="16" align="center">Total </td>
                     <td>Rp. <?php echo $barang_pakai->hargaBarang();?> </td>
                     <td></td>
                     <td colspan="2"></td>
                </tr>
            </tfoot>
