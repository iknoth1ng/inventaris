...
<head>
  ...
  <title>Sistem Informasi Inventaris dan Barang Dinas Komunikasi dan Informatika || Edit KIB D</title>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-4 text-gray-900">Edit Kartu Inventaris Barang D :</h1>
          <div class="row">

          <!-- Edit Kartu Inventaris C-->
          <div class="shadow-lg p-3 mb-5 col-sm-12 bg-white rounded">
          <form action="../modal/m.ubahKIBD.php" method="POST" data-parsley-validate class="form-horizontal form-label text-gray-900">
          <div class="form-group row">
                <label for="colFormLabel" class="control-label col-sm-2 col-form-label">ID KIB D :</label>
                <div class="col-sm-10 col-md-6">
                  <input type="text" readonly class="form-control text-gray-900" id="colFormLabel" name="id_kibD" value="<?php echo $_GET['id_kibD']; ?>" placeholder="ID">
                </div>
              </div>
            <div class="form-group row">
                <label for="colFormLabel" class="control-label col-sm-2 col-form-label">Jenis Barang/Nama Barang :</label>
                <div class="col-sm-10 col-md-6">
                  <input type="text" class="form-control text-gray-900" id="colFormLabel" name="jenis_barang" value="<?php echo $kib->cetak_kibD('jenis_barang',$_GET['id_kibD']); ?>" placeholder="Jenis Barang/Nama Barang" required>
                </div>
              </div>
              <div class="form-group row">
                <label for="colFormLabel" class="control-label col-sm-2 col-form-label">Nomor Kode Barang :</label>
                <div class="col-sm-10 col-md-6">
                  <input type="text" class="form-control text-gray-900" id="colFormLabel" name="kode_barang" value="<?php echo $kib->cetak_kibD('kode_barang',$_GET['id_kibD']); ?>" placeholder="Nomor Kode Barang" required>
                </div>
              </div>
              <div class="form-group row">
                <label for="colFormLabel" class="control-label col-sm-2 col-form-label">Nomor Register :</label>
                <div class="col-sm-10 col-md-6">
                  <input type="text" class="form-control text-gray-900" id="colFormLabel" name="nomor_register" value="<?php echo $kib->cetak_kibD('nomor_register',$_GET['id_kibD']); ?>" placeholder="Nomor Register" required>
                </div>
              </div>
              <div class="form-group row">
                <label for="colFormLabel" class="control-label col-sm-2 col-form-label">Konstruksi :</label>
                <div class="col-sm-10 col-md-6">
                  <input type="text" class="form-control text-gray-900" id="colFormLabel" name="konstruksi" value="<?php echo $kib->cetak_kibD('konstruksi',$_GET['id_kibD']); ?>" placeholder="Konstruksi">
                </div>
              </div>
              <div class="form-group row">
                <label for="colFormLabel" class="control-label col-sm-2 col-form-label">Panjang (Km) :</label>
                <div class="col-sm-10 col-md-6">
                  <input type="text" class="form-control text-gray-900" id="colFormLabel" name="panjang" value="<?php echo $kib->cetak_kibD('panjang',$_GET['id_kibD']); ?>" placeholder="Panjang (Km)">
                </div>
              </div>             
              <div class="form-group row">
                <label for="colFormLabel" class="control-label col-sm-2 col-form-label">Lebar (m) :</label>
                <div class="col-sm-10 col-md-6">
                  <input type="number" class="form-control text-gray-900" id="colFormLabel" name="lebar" value="<?php echo $kib->cetak_kibD('lebar',$_GET['id_kibD']); ?>" placeholder="Lebar (m)">
                </div>
              </div>  
              <div class="form-group row">
                <label for="colFormLabel" class="control-label col-sm-2 col-form-label">Luas :</label>
                <div class="col-sm-10 col-md-6">
                  <input type="number" class="form-control text-gray-900" id="colFormLabel" name="luas" value="<?php echo $kib->cetak_kibD('luas',$_GET['id_kibD']); ?>"  placeholder="Luas">
                </div>
              </div>
              <div class="form-group row">
                <label for="colFormLabel" class="control-label col-sm-2 col-form-label">Letak/Lokasi :</label>
                <div class="col-sm-10 col-md-6">
                  <input type="text" class="form-control text-gray-900" id="colFormLabel" name="letak" value="<?php echo $kib->cetak_kibD('letak',$_GET['id_kibD']); ?>"  placeholder="Letak/Lokasi" required>
                </div>
              </div>
              <div class="form-group row">
                <label for="colFormLabel" class="control-label col-sm-2 col-form-label">Tanggal Dokumen :</label>
                <div class="col-sm-10 col-md-6">
                  <input type="text" class="form-control text-gray-900" id="colFormLabel" name="tanggal" value="<?php echo $kib->cetak_kibD('tanggal',$_GET['id_kibD']); ?>" placeholder="Tanggal Dokumen" required>
                </div>
              </div>
              <div class="form-group row">
                <label for="colFormLabel" class="control-label col-sm-2 col-form-label">Nomor Dokumen :</label>
                <div class="col-sm-10 col-md-6">
                  <input type="number" class="form-control text-gray-900" id="colFormLabel" name="nomor" value="<?php echo $kib->cetak_kibD('nomor',$_GET['id_kibD']); ?>" placeholder="Nomor Dokumen">
                </div>
              </div>
              <div class="form-group row">
                <label for="colFormLabel" class="control-label col-sm-2 col-form-label">Status Tanah :</label>
                <div class="col-sm-10 col-md-6">
                  <input type="text" class="form-control text-gray-900" id="colFormLabel" name="status_tanah" value="<?php echo $kib->cetak_kibD('status_tanah',$_GET['id_kibD']); ?>" placeholder="Status Tanah">
                </div>
              </div>
              <div class="form-group row">
                <label for="colFormLabel" class="control-label col-sm-2 col-form-label">Nomor Kode Tanah :</label>
                <div class="col-sm-10 col-md-6">
                  <input type="number" class="form-control text-gray-900" id="colFormLabel" name="nomor_kodetanah" value="<?php echo $kib->cetak_kibD('nomor_kodetanah',$_GET['id_kibD']); ?>" placeholder="Nomor Kode Tanah">
                </div>
              </div>
              <div class="form-group row">
                <label for="colFormLabel" class="control-label col-sm-2 col-form-label">Asal Usul :</label>
                <div class="col-sm-10 col-md-6">
                  <input type="text" class="form-control text-gray-900" id="colFormLabel" name="asal_usul" value="<?php echo $kib->cetak_kibD('asal_usul',$_GET['id_kibD']); ?>" placeholder="Asal Usul">
                </div>
              </div>
              <div class="form-group row">
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-10 col-md-6">
                  <input type="number" class="form-control text-gray-900" id="duit" name="harga" value="<?php echo $kib->cetak_kibD('harga',$_GET['id_kibD']); ?>" placeholder="Harga (Rp)" required>
                </div>
              </div>
              <div class="form-group row">
                <label for="colFormLabel" class="control-label col-sm-2 col-form-label">Keterangan :</label>
                <div class="col-sm-10 col-md-6">
                  <input type="text" class="form-control text-gray-900" id="colFormLabel" name="keterangan" value="<?php echo $kib->cetak_kibD('keterangan',$_GET['id_kibD']); ?>"  placeholder="Keterangan">
                </div>
              </div>
