      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="row">
                ...
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      ...
                      <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo $peminjaman->count_data('count(id_peminjam) as myjumlah','myjumlah','list_peminjaman'); ?></div>
                    </div>
                    <div class="col-auto">
            ...
            <!-- Total Inventaris Card Example -->
            <div class="col-xl-3 col-md-6 mb-4">
              <div class="card border-left-success shadow h-100 py-2">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      <div class="text-xs font-weight-bold text-success text-uppercase mb-1">Total Inventaris</div>
                      <div class="h5 mb-0 font-weight-bold text-gray-800">
                      <?php 
                      $jumlah1 = $peminjaman->count_data('count(id_kibA) as myjumlah','myjumlah','kib_a');
                      $jumlah2 = $peminjaman->count_data('count(id_kibB) as myjumlah','myjumlah','kib_b');
                      $jumlah3 = $peminjaman->count_data('count(id_kibC) as myjumlah','myjumlah','kib_c');
                      $jumlah4 = $peminjaman->count_data('count(id_kibD) as myjumlah','myjumlah','kib_d');
                      $jumlah5 = $peminjaman->count_data('count(id_kibE) as myjumlah','myjumlah','kib_e');
                      $jumlah6 = $peminjaman->count_data('count(id_kibF) as myjumlah','myjumlah','kib_f');
                      $jumlahtotal = ($jumlah1 + $jumlah2 + $jumlah3 + $jumlah4 + $jumlah5 + $jumlah6) ;
                      echo $jumlahtotal;
                      ?>
                      </div>
                    </div>
                    ...
                    <div class="col mr-2">
                      ...
                      <div class="row no-gutters align-items-center">
                        <div class="col-auto">
                          ...
                          <?php 
                          $jumlah1 = $peminjaman->count_data('count(id_aset) as myjumlah','myjumlah','aset_tak_berwujud');
                          $jumlah2 = $peminjaman->count_data('count(id_asetlain) as myjumlah','myjumlah','aset_lain');
                          $jumlahtotal = ($jumlah1 + $jumlah2);
                          echo $jumlahtotal;
                          ?>
                          </div>
                        </div>
        ...
        <p><p>
          <img src="img/misi.png" class="img-fluid" alt="Responsive image"  width="800">
          <!-- <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner">
              <div class="carousel-item active">
                <img src="img/pemko.jpg" class="d-block w-100" alt="...">
              </div>
              <div class="carousel-item">
                <img src="img/misi.png" class="d-block w-100" alt="...">
              </div>
              <div class="carousel-item">
                <img src="img/kominfo.png" class="d-block w-100" alt="...">
              </div>
            </div>
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title text-gray-900" id="exampleModalLabel">Apakah Anda Yakin Ingin Keluar ? </h5>
          <button class="close" type="button" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">×</span>
          </button>
        </div>
        <div class="modal-body text-gray-900">Pilih Logout Apabila Anda Ingin Keluar</div>
