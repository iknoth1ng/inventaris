...
$data_acc = $kib->tambah_kibF($jenis_barang,$bangunan,$bertingkat,$beton,$luas,$letak,$tanggal,$nomor,$tahun_mulai,$status_tanah,$nomor_kodetanah,$asal_usul,$nilai_kontrak,$keterangan);
if($data_acc == true){
