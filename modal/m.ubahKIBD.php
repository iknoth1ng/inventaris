...
$data_acc = $kib->ubah_kibD($id_kibD,$jenis_barang,$kode_barang,$nomor_register,$konstruksi,$panjang,$lebar,$luas,$letak,$tanggal,$nomor,$status_tanah,$nomor_kodetanah,$asal_usul,$harga,$keterangan);
if($data_acc == true){
