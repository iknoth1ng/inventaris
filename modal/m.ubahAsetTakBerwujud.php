...
$data_acc = $aset->ubah_asettakberwujud($id_aset,$kode_barang,$nama_barang,$tahun_pembelian,$asal_usul,$harga,$amortisasi,$akm_amortisasi_2016,$beban_amortisasi,$akm_amortisasi_2017,$nilai_buku,$keterangan);
if($data_acc == true){
