...
$data_acc = $master_data->tambah_masterData($id_master,$golongan, $bidang, $kelompok, $sub_kelompok, $sub_sub_kelompok, $kode_barang, $uraian, $masa_manfaat, $nilai_penyusutan, $tahun);
if($data_acc == true){
