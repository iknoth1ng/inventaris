...
$data_acc = $kib->tambah_kibC($jenis_barang,$kode_barang,$nomor_register,$kondisi_bangunan,$bertingkat,$beton,$luas_lantai,$letak,$tanggal,$nomor,$luas,$status_tanah,$nomor_tanah,$asal_usul,$harga,$keterangan);
if($data_acc == true){
